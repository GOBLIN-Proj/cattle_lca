from cattle_lca.resource_manager.models import print_livestock_data, load_livestock_data
from cattle_lca.resource_manager.animal_data import AnimalData as ad
import pandas as pd 
